...
#define yuv2p01x_wrapper(bits)                                                 \
    ...
    {                                                                          \
        yuv2p01xlX_c(filter, filterSize, src, (uint16_t*)dest, dstW, 1, bits); \
                                                                               ...
                                                                               \
    static void yuv2p0 ## bits ## cX_LE_c(struct SwsContext *c,        \
                                          ...
                                          uint8_t *dest8, int chrDstW)         \
    {                                                                          \
        yuv2p01xcX_c(0, chrFilter, chrFilterSize, chrUSrc, chrVSrc, \
                     dest8, chrDstW, bits);                                    \
    }                                                                          \
                                                                               \
    static void yuv2p0 ## bits ## cX_BE_c(struct SwsContext *c,        \
                                          const int16_t *chrFilter,            \
                                          int chrFilterSize,                   \
                                          const int16_t **chrUSrc,             \
                                          const int16_t **chrVSrc,             \
                                          uint8_t *dest8, int chrDstW)         \
    {                                                                          \
        yuv2p01xcX_c(1, chrFilter, chrFilterSize, chrUSrc, chrVSrc, \
                     dest8, chrDstW, bits);                                    \
    }
